    ...
    <div class="school-form-page">
        <div v-if="loadingUser || !hasPermission" class="permission-check">
            ...
            <div v-else class="permission-denied">
                ...
                <h3>Khong the truy cap Tao truong hoc</h3>
                <p>Chi Superadmin, Admin va Manager moi co the tao truong hoc.</p>
        ...
        <div v-else class="form-wrapper">
            <div class="page-header">
                <div>
                    <h1><i class="fas fa-plus-circle"></i> Tao truong hoc</h1>
                    <p>Nhap thong tin truong hoc moi</p>
                </div>
            ...
            <form class="school-form" @submit.prevent="handleCreateSchool">
                <div class="form-grid">
                    <div class="form-group full">
                        ...
                        <input v-model.trim="form.name" @input="clearFieldError('name')" @blur="handleNameBlur" :class="['form-control', { 'is-invalid': !!formErrors.name }]" type="text" placeholder="Nhap ten truong hoc">
                    ...
                    <div class="form-group full">
                        ...
                        <input v-model.trim="form.location" @input="clearFieldError('location')" @blur="validateField('location')" :class="['form-control', { 'is-invalid': !!formErrors.location }]" type="text" placeholder="Vi du: Sydney, Australia">
                    ...
                    <div class="form-group">
                        ...
                        <input v-model.trim="form.logo_url" @input="clearFieldError('logo_url')" @blur="validateField('logo_url')" :class="['form-control', { 'is-invalid': !!formErrors.logo_url }]" type="url" placeholder="https://...">
                ...
                <div class="form-actions">
                    ...
                    <button class="btn btn-primary" type="submit" :disabled="saving">
                        ...
                        {{ saving ? 'Dang tao...' : 'Tao truong hoc' }}
                    </button>
                </div>
            </form>
        </div>
...
const validateField = (field) => {
    ...
    if (field === 'tuition_per_year') {
        if (form.tuition_per_year === null || form.tuition_per_year === undefined || form.tuition_per_year === '') {
    ...
    if (field === 'visa_success_rate') {
        if (form.visa_success_rate === null || form.visa_success_rate === undefined || form.visa_success_rate === '') {
    ...
    if (field === 'region_id') {
        if (form.region_id !== null && form.region_id !== undefined && (!Number.isInteger(Number(form.region_id)) || Number(form.region_id) < 1)) {
            formErrors.region_id = 'Khu vuc khong hop le'
            return false
        }
    ...
    if (field === 'type_id') {
        if (form.type_id !== null && form.type_id !== undefined && (!Number.isInteger(Number(form.type_id)) || Number(form.type_id) < 1)) {
            formErrors.type_id = 'Loai truong khong hop le'
            return false
        }
        formErrors.type_id = ''
        return true
...
const validateForm = () => {
    const fields = ['name', 'slug', 'location', 'tuition_per_year', 'class_size', 'visa_success_rate', 'region_id', 'type_id', 'status', 'logo_url', 'thumbnail_url', 'features']
